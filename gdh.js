...
const ROLES=[['anfitrion','Anfitrion'],['tecnico','Tecnico'],['charly','Charly'],['eco','ECO'],['supervisor','Supervisor'],['fortaleza','Fortaleza'],['admin','Administrador'],['gdh','GDH'],['encargado_ti','Encargado de Mantenimiento y TI'],['jefe_operaciones','Jefe de operaciones'],['coordinador_operaciones','Coordinador de operaciones']];
const FILE_CATEGORIES=[['reclutamiento','Proceso de reclutamiento y seleccion'],['datos_personales','Datos personales'],['familiares','Datos de familiares directos'],['experiencia','Experiencia laboral'],['formacion','Formacion, estudios y capacitacion'],['ingreso','Documentos organizacionales de ingreso'],['contrato','Contrato de trabajo y anexos'],['organizacional','Documentos organizacionales'],['politica','Politicas y reglamentos'],['sst','Seguridad y salud en el trabajo'],['desempeno','Evaluacion de desempeno'],['disciplinario','Gestion disciplinaria'],['boleta','Boletas y comprobantes'],['formulario','Formularios firmados'],['constancia','Constancias'],['otro','Otros documentos']];
...
async function init(){
  ...
  $('gdhManagementTab').hidden=!isManager();$('gdhFilesTab').hidden=!isManager();await loadUsers();await Promise.all([loadDocuments(),loadAnnouncements()]);if(isManager())renderPersonnelDirectory();
